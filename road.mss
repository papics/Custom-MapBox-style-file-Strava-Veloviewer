...
#bridge {
  ...
  [class='main'][type='trunk']['mapnik::geometry_type'=2] {
    ...
    ::fill[zoom>=10] {
      line-color: @primary;
      line-cap: round;
      #tunnel { line-color: mix(@primary,@land,50); }
  ...
  [class='main'][type='secondary']['mapnik::geometry_type'=2] {
    ::case[zoom>=6] {
      line-color: @case;
      [zoom<=9] { line-color: @secondary; }
      #road { line-cap: round; }
      #tunnel { line-dasharray: 3,3; }
      line-width: 0.4;
      [zoom>=10] { line-width: 2.0; }
    ...
    ::fill[zoom>=10] {
      ...
      line-cap: round;
      #tunnel { line-color: mix(@secondary,@land,50); }
      [zoom>=10] { line-width: 1; }
      [zoom>=11] { line-width: 1.1; }
      [zoom>=12] { line-width: 1.25; }
      [zoom>=13] { line-width: 1.5; }
  ...
  [class='main'][type='tertiary']['mapnik::geometry_type'=2] {
    ::case[zoom>=6] {
      line-color: @case;
      [zoom<=9] { line-color: @tertiary; }
      #road { line-cap: round; }
      #tunnel { line-dasharray: 3,3; }
      line-width: 0.4;
      [zoom>=10] { line-width: 2.0; }
    ...
    ::fill[zoom>=10] {
      line-color: @tertiary;
      line-cap: round;
      #tunnel { line-color: mix(@tertiary,@land,50); }
      [zoom>=10] { line-width: 1; }
      [zoom>=11] { line-width: 1.1; }
      [zoom>=12] { line-width: 1.25; }
      [zoom>=13] { line-width: 1.5; }
  ...
  [class='service']['mapnik::geometry_type'=2] {
    ...
    ::path[zoom>=13]['mapnik::geometry_type'=2] {  
      [type='track'] {
        line-join: round;
        line-width: 1;
        line-color: #bba;
  ...
  [class='driveway']['mapnik::geometry_type'=2] {
    ::case[zoom>=15] {
      line-color: #000;
      line-opacity: 0.04;
      #road { line-cap: round; }
